...
public class WebPage {
    ...
    /**
     * override of toString method that will return a String in a 
     * tabular form of the variable in this class. The strings are formatted
     * Since the links are not assigned yet, the output will be ****, this 
     * will be replaced using the string.replace and the correct links will 
     * be placed in WebGraph class. 
     * @return 
     *      String format of the variables in this class in a tabular form. 
     */
